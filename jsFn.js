(function () {
    ...
    var ajaxRequest = function (opts) {
        if (true == opts.async) {
            $("body").append('<div class="widget-box-overlay" style="z-index:22222;"><i class=" ace-icon loading-icon fa fa-spinner fa-spin fa-2x white"></i></div>');
        };
        var options;
        options = {
            type: "post",
